...
<template>
    <div class="group h-full rounded-3xl sm:max-h-64 relative overflow-hidden">
        <div class="h-full min-h-full">
            <div class="rounded-xl shadow-md overflow-hidden sm:flex md:space-y-4">
                <div class="sm:h-full sm:w-1/2 p-2 md:p-4">
                    <img
                        :src="blog.cover"
                        class="rounded-lg my-auto overflow-hidden object-cover aspect-square object-left lg:size-full max-h-52 md:max-h-80"
                    />
                </div>
                ...
                <div class="sm:w-1/2 text-left px-4 h-full md:py-2">
                    <div>
                        ...
                        <div class="py-2 text-sm text-secondary-400">
