<a href="{{ route('blogs.show', $blog)  }}">
    <div class="sm:flex h-full gap-2 hover:bg-gray-800 transition bg-gray-950 rounded">
        ...
        <div class="sm:w-1/2 p-2 text-left min-h-56">
            <div class="flex">
                ...
                <div class="flex my-auto gap-0.5 ml-2 text-sm text-gray-400">
                    <x-icons.heart class="!size-3 fill-primary-700 my-auto"/>
            ...
            <div class="line-clamp-6 mt-2 text-sm text-gray-500">
